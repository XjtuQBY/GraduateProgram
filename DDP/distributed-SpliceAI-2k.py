...
model = SpliceAI2kModel(input_channels=4, num_classes=2)
...
for epoch in range(num_epochs):
    ...
    if best_f1_score is None or avg_f1_score > best_f1_score:
        ...
        counter = 0
        torch.save(model.state_dict(), 'best_CNNRB_model_250212.pth')
...
# 测试
model.load_state_dict(torch.load('best_CNNRB_model_250212.pth'))
model.eval()
test_loss = 0
f1_metric.reset()
conf_matrix_metric.reset()
