    ...
    for epoch in range(num_epochs):
        ...
        if val_f1 > best_val_f1:
            ...
            torch.save({
                ...
                'val_f1': val_f1.item()
            }, 'best_Enhanced_BERT_Promoter579_model.pth')
...
if __name__ == "__main__":
    ...
    #criterion = FocalDiceLoss(alpha=0.7, gamma=2.5, beta=0.3)
    ...
    checkpoint = torch.load('best_Enhanced_BERT_Promoter579_model.pth')
